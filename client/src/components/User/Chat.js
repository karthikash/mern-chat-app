...
class Chat extends Component {
    ...
    constructor(props) {
        ...
        this.socket = io(Constants.REACT_APP_SOCKET);
    }
    ...
    isActive = (index, user) => {
        ...
        fetch(`${Constants.REACT_APP_API_BASE_URL}/chat/list?sender=${userId}&receiver=${user._id}`, options)
            .then(async (success) => {
                                                        ...
                                                        <Col md="6" style={{ textAlign: "end" }}>
                                                            {message.sMessage.includes('http://') ?
                                                                (message.sMessage.includes('.mp4') ?
                                                                    <video src={message.sMessage} height="100%" width="100%" controls autoPlay muted></video>
                                                                    :
                                                                    <img src={message.sMessage} height="100%" width="100%" alt="" style={{ borderRadius: "10px" }}></img>
                                                                )
                                                                :
